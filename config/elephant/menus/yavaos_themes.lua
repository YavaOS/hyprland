--
-- Dynamic YavaOS Theme Menu for Elephant/Walker
--
Name = "yavaosthemes"
NamePretty = "YavaOS Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/yavaos/themes"
  -- local yavaos_path = os.getenv("YAVAOS_PATH") or ""
  local yavaos_path = '/home/ainyava/w/yavaos/hyprland'
  local default_theme_dir = yavaos_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "yavaos-theme-set " .. theme_name,
            },
          })
        end
      end
